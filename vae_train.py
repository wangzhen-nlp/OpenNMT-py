...
parser.add_argument('-mid_size', type=int, default=1000)
parser.add_argument('-bow_mid_size', type=int, default=1000)
...
def make_loss_compute(model, tgt_vocab, dataset, opt):
    ...
    compute = onmt.Loss.VAENMTLossCompute(opt, model.generator, tgt_vocab, model.bow_project)
...
def build_model(model_opt, opt, fields, checkpoint):
    ...
    model = onmt.ModelConstructor.make_vae_base_model(model_opt, fields,
